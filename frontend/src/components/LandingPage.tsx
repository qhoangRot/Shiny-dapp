...
function MarketsTable() {
  ...
  const rows = [
    { symbol: 'USDC', base: usdcBase, logo: usdcLogo },
    { symbol: 'EURC', base: eurcBase, logo: eurcLogo },
  ];
        ...
        {rows.map((row) => (
          <tr key={row.symbol}>
            <td className="asset-cell">
              <span className="asset-with-logo">
                <img src={row.logo} alt={row.symbol} className="asset-logo" />
                <span>
        ...
        <footer className="landing-footer">
          <div className="footer-top">
            <div className="footer-brand">
              <strong>Shiny</strong>
              <p className="footer-tagline">Revenue - sharing lending protocol</p>
            </div>
